...
C_DirectionalAnimation::C_DirectionalAnimation(Object* owner) : Component(owner, true),
...
void C_DirectionalAnimation::LoadDependencies(Object* owner)
{
...
void C_DirectionalAnimation::Update(float deltaTime, Object* owner)
{
	...
	if (m_currentTextureIndex != static_cast<int>(animState))
	{
		...
		m_sprite->GetSprite().setTexture(m_textures[m_currentTextureIndex]);
	}
