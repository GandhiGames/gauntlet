...
C_KeyboardController::C_KeyboardController(Object* owner) : Component(owner, true)
{
	m_speed = 200;
}
...
void C_KeyboardController::LoadDependencies(Object* owner)
{
	m_movement = owner->GetComponent<C_Movement>();
	m_transform = owner->m_transform;
}

void C_KeyboardController::Update(float timeDelta, Object* owner)
{
	...
	Level* level = owner->GetContext()->m_level;
